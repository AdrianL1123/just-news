      ...
      <div className="py-3 pb-8">
        {COUNTRIES.map((country, i) => (
          <div key={country.code}>
            ...
            <p className="px-4 pt-3 pb-1.5 text-[11px] font-semibold tracking-[0.12em] uppercase text-foreground/50">
              {country.label}
            </p>
            {CATEGORIES.map(({ id, label, Icon }) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'w-full flex items-center gap-2 px-3 py-2 text-sm text-foreground border-l-2 border-transparent transition-all text-left',
